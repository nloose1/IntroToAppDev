        ...
        <tr>
            <td align="right">
                <asp:Literal ID="Literal1" runat="server"
                     Text="Programming Course"></asp:Literal></td>
            <td>
                <asp:CheckBox ID="ProgrammingCourseActive" runat="server" 
                     Text="(programming course is checked)"/></td>
        </tr>
        <tr>
            <td align="right">
        ...
        <tr>
            <td align="right">
                <asp:Label ID="Label4" runat="server" 
                    Text="Selection of Course"></asp:Label></td>
            <td>
                <asp:DropDownList ID="CollectionChoiceList" runat="server"></asp:DropDownList>
                &nbsp;&nbsp;
                <asp:LinkButton ID="CollectionSubmit" runat="server" OnClick="CollectionSubmit_Click">Submit Selection</asp:LinkButton>
            </td>
        </tr>
        <tr>
            <td colspan="2">&nbsp;</td>
