...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        <asp:GridView ID="ProductList" runat="server"
            ...
            DataSourceID="ProductListODS" GridLines="Horizontal" BorderStyle="None" CssClass="table table-striped" AllowPaging="True" PageSize="5">
              <Columns>
                ...
                <asp:TemplateField HeaderText="Supplier">
                    <ItemTemplate>
                        <asp:DropDownList ID="SupplierList" runat="server" DataSourceID="SupplierListODS" DataTextField="CompanyName" DataValueField="SupplierID" SelectedValue='<%# Eval("SupplierID") %>'>
                       </asp:DropDownList>
                    </ItemTemplate>
